...
def get_water_heating_properpties():
    ...
    store_indiviudal_properties( water_heating_properties_as_list, 'water_heating', 'Not Electric', 'Electric')
...
def get_space_heating_properties():
    ...
    store_indiviudal_properties( space_heating_properties_as_list, 'space_heating', 'Not Electric', 'Electric')
