...
if 'CompareExplanations' in sys.argv:
    #model = keras.models.load_model('./results/inception/_itr_1/single/last_model.hdf5', compile=True)
    # explainer_lime = xai_lime.Lime(property_name='cooking', class_names=['Not Electric', 'Electric'], num_features= 30)
    # explainer_lime.create_comparation_metrics()
    explainer_shap = xai_shap.Shap(property_name='cooking', class_names=['Not Electric', 'Electric'], num_features= 30)
    explainer_shap.create_comparation_metrics()
    # explainer_lime = xai_lime.Lime(property_name='space_heating', class_names=['Not Electric', 'Electric'], num_features= 30)
    # explainer_lime.create_comparation_metrics()
    explainer_shap = xai_shap.Shap(property_name='space_heating', class_names=['Not Electric', 'Electric'], num_features= 30)
    explainer_shap.create_comparation_metrics()
    # explainer_lime = xai_lime.Lime(property_name='water_heating', class_names=['Not Electric', 'Electric'], num_features= 30)
    # explainer_lime.create_comparation_metrics()
    explainer_shap = xai_shap.Shap(property_name='water_heating', class_names=['Not Electric', 'Electric'], num_features= 30)
    explainer_shap.create_comparation_metrics()
    # explainer_lime = xai_lime.Lime(property_name='num_devices', class_names=['Few', 'Moderate', 'Many'], num_features= 20)
    # explainer_lime.create_explanations()
    # explainer_shap = xai_shap.Shap(property_name='num_devices', class_names=['Few', 'Moderate', 'Many'], num_features= 20)
